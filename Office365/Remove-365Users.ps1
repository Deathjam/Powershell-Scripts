...
function Remove-365Users {
    <#
    .DESCRIPTION
        Remove Office 365 Users and convert to shared mailbox, from csv
    .EXAMPLE
        Remove-365Users -CSVPath <PATH TO CSV FILE>
    .NOTES
        CSV file format: list of email addresses, don't use a header.
    #>
    param(
